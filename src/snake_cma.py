...
def main():
    parser = argparse.ArgumentParser(description='run CMA on Snakemake',
    ...
    parser.add_argument('--plink', type=str, help='PLINK2 path for running F+CMA',
                        required=True)
    ...
    parser.add_argument('--cma-inflate', type=float, help="CMA's inflation factor, default=0.2")
